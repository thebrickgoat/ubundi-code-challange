...
.heroModalText p {
  background: linear-gradient(#ffffff, #ffffff) 50% 50% / calc(100% - 8px)
      calc(100% - 8px) no-repeat,
    linear-gradient(90deg, #611818 0%, rgba(255, 255, 255, 0) 50%) no-repeat 0 0/100%
      2px;
  border-radius: 0px;
  padding: 30px 0;
  box-sizing: content-box;
  font-family: var(--vt-t-body);
  font-weight: 400;
  font-size: 18px;
  line-height: 36px;
}
